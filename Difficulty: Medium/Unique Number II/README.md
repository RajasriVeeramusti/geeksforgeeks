<h2><a href="https://www.geeksforgeeks.org/problems/finding-the-numbers0215/1?_gl=1*h92rkq*_up*MQ..*_gs*MQ..&gclid=CjwKCAjwn6LABhBSEiwAsNJrjlWQkjI77b2jLReSuEluPw1Vhvd-oTxfPwSB9I-qHBdykHQKDErzKhoC6F8QAvD_BwE&gbraid=0AAAAAC9yBkA1UCBFuR07jp9yCfQbpl0Iv">Unique Number II</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong> containing <strong>2*n + 2</strong> positive numbers, out of which <strong>2*n numbers exist in pairs</strong> whereas the other two number occur exactly once and are <strong>distinct</strong>. Find the other two numbers. Return the answer in increasing order.</span></p>
